...
def comprehend_video(video_path: str, prompt: str = "请详细描述这段视频的内容", use_base64: bool = True) -> str:
    """
    理解视频内容并返回描述
    ...
    try:
        ...
        raise Exception(f"视频理解API调用失败: {str(e)}")
...
if __name__ == "__main__":
    # 示例用法
    test_video_path = r"D:/test1/video001.mp4"  # 替换为实际的视频路径
